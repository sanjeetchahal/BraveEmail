<div class="max-w-xl mx-auto">
    ...
    <?php
      ...
      $tabs = '[
          {"label": "Getting Started", "tabview": ""},
          {"label": "Google JSON", "tabview": "gjson"},
      ...
      foreach ($tabsArray as $tab) {
        ...
        echo '<li class="mr-2">';
        echo '<a href="' . admin_url('options-general.php?page=brave_email_smtp&provider=google&tabview='.$tab['tabview']) . '" class="inline-block p-4 border-b-2 border-transparent rounded-t-lg ' . $isActive . ' ' . $isDisabled . '" aria-current="page">' . $tab['label'] . '</a>';
        echo '</li>';
      }
      echo '</ul>';
      echo '</div>';
